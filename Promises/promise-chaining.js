...
function fetchGithub() {
    fetch(`https://api.github.com/users/${allUsers.user1}`)
    ...
    .then((user) => {
        ...
        return fetch(`https://api.github.com/users/${allUsers.user2}`)
    })
    // next fetch's data
    .then(response => response.json())
    .then((user) => {
        ...
        return fetch(`https://api.github.com/users/${allUsers.user3}`)
    })
    .then(response => response.json())
    .then((user) => {
